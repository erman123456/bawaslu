        ...
        <div class="adv-table editable-table ">
          ...
          @endif
              <div class="btn-group pull-right">
               <button type="button" class="btn btn-primary btn-xs tambahPilkada" data-toggle="modal" data-target="#form_modal">
                  Tambah Data
               </button>
              </div>
           </div>
                         ...
                         <tbody>
                             ...
                             <tr>
                                 ...
                                 <td  class='text-center'><?php  if($row->putusan_penyelesaian) { ?> 
                                    <a href="{{route('pilkada.putusan_penyelesaian', $row->uid)}}" class="btn btn-label-right"><i class="fa fa-download"> Download</i></a> <?php } else{ echo "Data Tidak Tersedia"; } ?> </td>

                                 <td  class='text-center'><?php  if($row->tindak_lanjut) { ?>
                                    <a href="{{route('pilkada.tindak_lanjut', $row->uid)}}" class="btn btn-label-right"><i class="fa fa-download"> Download</i> </a> <?php } else{ echo "Data Tidak Tersedia"; } ?> </td>
                                    
                                 
                                 <td>
                                    <a href="#" class="btn btn-warning btn-xs float-right ml-1 EditPilkada" data-toggle="modal" data-target="#form_modal" data-id="{{$row->uid}}" title="Edit"><i class="fa fa-edit"></i></a>

                                     <button type="button" rel="tooltip" class="btn btn-xs btn-danger btnHapus-pilkada" data-original-title="Hapus" title="Hapus" id="{{$row->uid}}"><i class="fa fa-trash-o"></i></button>
                                 </td>
                             </tr>
                             @endforeach
                         </tbody>
      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
           ...
           @endif
               ...
               <input type="hidden" id="url" name="url" value="{{url("pilkada_edit")}}" class="form-control" >
               <div class="row"> 
                <div class="col-lg-4">
                    <section class="panel">
                        <div class="panel-body">
...
//  Tambah Paslon
$("body").on("click", ".tambahPilkada" , function(){
   $('#judulModal').html('Tambah Data Pilkada');
   $('.modal-footer button[type=submit]').html('Save');
   $('.modal-body form').attr('action', 'pilkada_input');
...
$('.EditPilkada').on('click', function(){
   $('#judulModal').html('Edit Data Pilkada');
   $('.modal-footer button[type=submit]').html('Edit');
   $('.modal-body form').attr('action', 'pilkada_update')
...
$("body").on("click" , ".btnHapus-pilkada", function(){
	var id = this.id;
	swal({
		...
		swal({
			...
			document.location.href = 'pilkada_delete/'+id;
		});
		} 
		else {
